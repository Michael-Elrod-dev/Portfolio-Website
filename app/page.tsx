            ...
            <div className="flex w-full">
              <div className="w-1/2">
                ...
                <div className="space-y-4">
                  ...
                  <br />
                  <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition duration-300">Resume</a>
                </div>
              </div>
